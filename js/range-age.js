  ...
  $(".date-age:input").inputmask();
  
  $(".slider-txt-age:input").inputmask({
    alias: 'numeric', 
    groupSeparator: '.',
    allowPlus:true,
    allowMinus:false, 
  ...
  $(".slider-age").each(function() {

    var $sibling = $(this).closest(".slider-container-age").find(".slider-txt-age");
    ...
    $sibling.blur(function() {
      var $sibling = $(this).closest(".slider-container-age").find("input.slider-age");
      var newvalue = parseInt($(this).val());
      var oldvalue = parseInt($sibling.val());
...
(function(root, factory) {
  ...
  **************************************************/
  ...
  (function($) {
    ...
    function createNewSlider(element, options) {
      ...
      **************************************************/
      ...
      function getDataAttrib(element, optName) {
        var dataName = "data-slider-age-" + optName.replace(/_/g, '-');
      ...
      **************************************************/
      ...
      if (this.sliderElem) {
        ...
        this.sliderElem.className = "slider-age";

        /* Create slider track elements */
        var sliderTrack = document.createElement("div");
        sliderTrack.className = "slider-track-age";

        sliderTrackLow = document.createElement("div");
        sliderTrackLow.className = "slider-track-low-age";

        sliderTrackSelection = document.createElement("div");
        sliderTrackSelection.className = "slider-selection-age";

        sliderTrackHigh = document.createElement("div");
        sliderTrackHigh.className = "slider-track-high-age";

        sliderMinHandle = document.createElement("div");
        sliderMinHandle.className = "slider-handle-age min-slider-handle-age";

        sliderMaxHandle = document.createElement("div");
        sliderMaxHandle.className = "slider-handle-age max-slider-handle-age";
    ...
    Slider.prototype = {
      ...
      destroy: function(){
        ...
        if($) {
          ...
          this.$element.removeData('slider-age');
        }
      },
      ...
      refresh: function() {
        ...
        if($) {
          ...
          $.data(this.element, 'slider-age', this);
        }
        return this;
      },
    ...
    *********************************/
    if($) {
      var namespace = $.fn.slider ? 'bootstrapSlider' : 'slider-age';
